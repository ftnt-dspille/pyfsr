...
# ---------------------------------------------------------------------------
# Roles, teams, people, tags, comments, reports, routers, rules, notifications
# ---------------------------------------------------------------------------
# Real captures (trimmed to 2-3 representative members, envelope-only for empty sets).
# Captured from a live FortiSOAR 8.0.x appliance.

ROLES_LIST_RESPONSE = {
    "@context": "/api/3/contexts/Role",
    "@id": "/api/3/roles",
    "@type": "hydra:Collection",
    "hydra:member": [
        {
            "@id": "/api/3/roles/02216a19-8930-4f6f-8173-8fbfae9fdee0",
            "@type": "Role",
            "description": "Manages required permission for Agentic AI",
            "name": "Agentic AI",
            "uuid": "02216a19-8930-4f6f-8173-8fbfae9fdee0",
            "importedBy": [{"apiName": "fortinetAdvisor", "name": "FortiAI", "version": "6.0.0"}],
        },
        {
            "@id": "/api/3/roles/7b56d139-7ee6-455e-8658-35727e202b8a",
            "@type": "Role",
            "description": "Alert triaging and false-positive filtering.",
            "name": "SOC Analyst",
            "uuid": "7b56d139-7ee6-455e-8658-35727e202b8a",
            "importedBy": [{"apiName": "sOAREssentials", "name": "SOAR Essentials", "version": "1.0.0"}],
        },
        {
            "@id": "/api/3/roles/c5ff8174-b3fa-41c5-b781-2b890b426a80",
            "@type": "Role",
            "description": "Full access to general application-wide features for system configuration",
            "name": "Application Administrator",
            "uuid": "c5ff8174-b3fa-41c5-b781-2b890b426a80",
            "importedBy": [],
        },
    ],
    "hydra:totalItems": 3,
    ...
    "hydra:member": [
        {
            ...
            "name": "SOC Team",
            "uuid": "6e569c09-3bd4-40f1-98b0-cc994464c3c5",
            "importedBy": [],
        }
    ],
    "hydra:totalItems": 1,
    ...
    "hydra:member": [
        {
            ...
            "createDate": 1781872210.020616,
            "modifyUser": "/api/3/people/3451141c-bac6-467c-8d72-85e0fab569ce",
            "modifyDate": 1781872210.020616,
            "id": 3,
            "userId": "70a1380d-3889-476d-b71d-b235d792a0a4",
            "@settings": "/api/3/user_settings/3451141c-bac6-467c-8d72-85e0fab569ce",
        },
        {
            "@id": "/api/3/people/441c0092-8db1-4299-ba1a-6d704465465a",
            "@type": "Person",
            "firstname": "Tenant",
            "lastname": "User",
            "title": "Admin",
            ...
            "userType": None,
            "avatar": None,
            "uuid": "441c0092-8db1-4299-ba1a-6d704465465a",
            "createUser": "/api/3/people/441c0092-8db1-4299-ba1a-6d704465465a",
            "createDate": None,
            "modifyUser": "/api/3/people/441c0092-8db1-4299-ba1a-6d704465465a",
            "modifyDate": None,
            "id": 4,
            "userId": "08e000fe-9dd0-4b59-a057-19ae9738e4d1",
            "@settings": "/api/3/user_settings/441c0092-8db1-4299-ba1a-6d704465465a",
        },
    ],
    "hydra:totalItems": 2,
    "hydra:view": {"@id": "/api/3/people?%24limit=5", "@type": "hydra:PartialCollectionView"},
}

TAGS_LIST_RESPONSE = {
    "@context": "/api/3/contexts/Tag",
    "@id": "/api/3/tags",
    "@type": "hydra:Collection",
    "hydra:member": ["2022 Annual Report", "3CX Supply Chain Attack", "Agentic AI"],
    "hydra:totalItems": 3,
    "hydra:view": {
        "@id": "/api/3/tags?%24limit=20&%24page=1",
        "@type": "hydra:PartialCollectionView",
        "hydra:first": "/api/3/tags?%24limit=20&%24page=1",
        "hydra:last": "/api/3/tags?%24limit=20&%24page=1",
        "hydra:next": None,
    },
}
...
REPORTS_LIST_RESPONSE = {
    ...
    "hydra:member": [
        {
            "@id": "/api/3/reporting/11ece146-396e-42f8-a2c4-358550c6f03f",
            "@type": "Reporting",
            "uuid": "11ece146-396e-42f8-a2c4-358550c6f03f",
            "createUser": {
                ...
                "createUser": None,
                "createDate": 1781872210.014607,
                "modifyUser": None,
                "modifyDate": 1781872210.014607,
                "id": 1,
                "userId": "6f3626c1-0da7-4b44-8d5e-43750f780a47",
            },
            "createDate": 1781873513.570913,
            "modifyUser": {
                "@id": "/api/3/appliances/57545210-2adc-472b-a24f-2df6ee8dfe63",
                "@type": "Appliance",
                "name": "Playbook",
            ...
            "modifyDate": 1781873513.570913,
            "importedBy": [{"apiName": "sOARFramework", "name": "SOAR Framework", "version": "4.0.0"}],
        ...
        {
            "@id": "/api/3/reporting/2bc7fd32-1dd6-48b0-bcfb-3a7c04938c4a",
            "@type": "Reporting",
            "uuid": "2bc7fd32-1dd6-48b0-bcfb-3a7c04938c4a",
            "createUser": {
                "@id": "/api/3/appliances/57545210-2adc-472b-a24f-2df6ee8dfe63",
                "@type": "Appliance",
                "name": "Playbook",
            ...
            "modifyDate": 1781873513.755819,
            "importedBy": [{"apiName": "sOARFramework", "name": "SOAR Framework", "version": "4.0.0"}],
            "displayName": "Weekly IOC Report",
            "type": "rows",
            "templateType": "reporting",
            "parentTemplateId": None,
            "filterArray": [],
...
COMMENTS_LIST_RESPONSE = {
    ...
    "hydra:member": [
        {
            "@id": "/api/3/comments/00003c74-dfe8-47cf-bcb5-803822dfa1fd",
            "@type": "Comment",
            "content": "<p>Asset owner notified. Holding as Open.</p>",
            "isDeleted": None,
            "file": None,
            "type": {
            ...
            "replyTo": None,
            "uuid": "00003c74-dfe8-47cf-bcb5-803822dfa1fd",
            "createUser": {
                "@id": "/api/3/appliances/57545210-2adc-472b-a24f-2df6ee8dfe63",
                "@type": "Appliance",
                "name": "Playbook",
            ...
            "modifyDate": 1782908691.434936,
            "tenant": {
                "@id": "/api/3/tenants/b3a700f7-00be-4ef9-90c6-3c8fe6e1be63",
                "@type": "Tenant",
                "name": "Self",
                "isDedicated": True,
                "tenantId": "2215f975dd501e6f25f55568edf06af9",
                "role": "self",
                "description": "sample",
            ...
            "conflict": False,
            "tenantRecordId": 59937,
            "id": 59937,
            "recordTags": [],
        },
        {
            "@id": "/api/3/comments/000054fc-eb61-47bc-bb99-b3afde460bd9",
            "@type": "Comment",
            "content": "<p>Alert created by correlation rule. Running enrichment.</p>",
            "isDeleted": None,
            "file": None,
            "type": {
                "@id": "/api/3/picklists/ff599189-3eeb-4c86-acb0-a7915e85ac3b",
            ...
            "replyTo": None,
            "uuid": "000054fc-eb61-47bc-bb99-b3afde460bd9",
            "createUser": {
                "@id": "/api/3/appliances/57545210-2adc-472b-a24f-2df6ee8dfe63",
                "@type": "Appliance",
                "name": "Playbook",
    ...
    "hydra:totalItems": 2,
    "hydra:view": {
        "@id": "/api/3/comments?%24limit=5&%24page=1",
        "@type": "hydra:PartialCollectionView",
        "hydra:first": "/api/3/comments?%24limit=5&%24page=1",
        "hydra:last": "/api/3/comments?%24limit=5&%24page=1",
        "hydra:next": None,
    },
}

ROUTERS_LIST_RESPONSE = {
    "@context": "/api/3/contexts/Router",
    "@id": "/api/3/routers",
    "@type": "hydra:Collection",
    "hydra:member": [],
    "hydra:totalItems": 0,
    "hydra:view": {"@id": "/api/3/routers?%24limit=20", "@type": "hydra:PartialCollectionView"},
}

PREPROCESSING_RULES_RESPONSE = {
    "@context": "/api/3/contexts/PreprocessingRule",
    "@id": "/api/3/preprocessing_rules",
    "@type": "hydra:Collection",
    "hydra:member": [
        {
            "@id": "/api/3/preprocessing_rules/2cd85eae-6d90-4644-a741-792c6c97fb30",
            "@type": "PreprocessingRule",
            "applicableOn": "incoming",
            "skipPlaybookExecution": None,
            "isActive": True,
            "priority": 1,
            "entityType": "indicators",
            "description": "The rule ensures file indicators are only created when files are attached.",
            "action": {"link": False, "update": []},
            "criteria": {
                "days": "1",
                "condition": {
                    "sort": [],
                    ...
                    "logic": "AND",
                    "filters": [
                        {"type": "primitive", "field": "file", "value": "", "operator": "eq", "_operator": "eq"}
                    ],
                },
            },
            "name": "Enforcing File Attachments for File Indicators",
            "actionType": {
                "@id": "/api/3/picklists/e71346e9-408f-4989-8eef-fa170ca05515",
                "@type": "Picklist",
                "itemValue": "Drop",
                "orderIndex": 1,
                "color": None,
                "icon": None,
                "listName": "/api/3/picklist_names/86eed510-257d-4aa8-8c51-e05e96b5ac3d",
                "uuid": "e71346e9-408f-4989-8eef-fa170ca05515",
                "id": 183,
                "importedBy": [],
            },
            "endDate": None,
    ...
    "hydra:totalItems": 1,
    "hydra:view": {"@id": "/api/3/preprocessing_rules?%24limit=10", "@type": "hydra:PartialCollectionView"},
}

NOTIFICATIONS_LIST_RESPONSE = {
    "@context": "/rule/api/system-notification/notifications/context/",
    "hydra:nextPage": None,
    "hydra:previousPage": None,
    "hydra:totalItems": 2,
    "hydra:itemsPerPage": 2,
    "hydra:firstPage": "/rule/api/system-notification/notifications/?$limit=5",
    "hydra:lastPage": "/rule/api/system-notification/notifications/?$limit=5",
    "hydra:member": [
        {
            "uuid": "7f7f96ca-acb1-4adf-82e2-f57ee0bcd420",
            "content": "<p>A task has been assigned to you!</p>",
            "footer": [],
            "entity_type": "tasks",
            "event_type": "create",
            "entity_id": "0fca18d8-d5ef-4c68-8e79-fde919a5cc99",
            "read": False,
            "dismissible": True,
            "created_on": "2026-07-18T12:27:16.775290Z",
            "roles": [],
            "user": "3451141c-bac6-467c-8d72-85e0fab569ce",
            "teams": [],
        },
        {
            "uuid": "7d7b1ddf-e21f-4ec1-93a6-f2f4381c562b",
            "content": "<p>A task has been assigned to you!</p>",
            "footer": [],
            "entity_type": "tasks",
            "event_type": "create",
            "entity_id": "420a2e6c-eb14-494e-9e6d-9dbcbd504cbb",
            "read": False,
            "dismissible": True,
            "created_on": "2026-07-18T12:26:55.694226Z",
            "roles": [],
            "user": "3451141c-bac6-467c-8d72-85e0fab569ce",
            "teams": [],
        },
